 ...
 *
 * Phase D1 markup ownership lives in templates/home/content.php. This bridge
 * only prepares presentation context that belongs to the existing Home view.
 * Zero-product orientation remains "Gunakan katalog atau konsultasi teknis"
 * in the composition owner so the Home always has an honest next path.
 *
 * @package GrahaSelang
 */
