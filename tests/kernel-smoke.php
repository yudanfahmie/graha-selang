...
$kernel = new \GrahaSelang\Kernel( dirname( __DIR__ ) . '/graha-selang.php', '0.2.0' );
$kernel->boot();

sort( $GLOBALS['hooks'] );
$expected = array( 'admin_enqueue_scripts', 'admin_menu', 'after_setup_theme', 'wp_enqueue_scripts' );
sort( $expected );
...
echo "PASS: Kernel boots exactly the expected Wave 1 hooks\n";
